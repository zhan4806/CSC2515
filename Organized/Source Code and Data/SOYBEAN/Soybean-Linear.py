...
file = open('SOYBEAN_linear_result.txt','w') 
script_dir = os.path.dirname(__file__) #<-- absolute dir the script is in
soybean_path1 = "Classification Dataset/SOYBEAN/soybean-large.data"
soybean_path2 = "Classification Dataset/SOYBEAN/soybean-large.test"
test_ratio=0.2
...
def main():
    train_data, train_target,test_data,test_target=load_data([soybean_path1,soybean_path2],35)

...
file = open('German_linear_result.txt','w') 
script_dir = os.path.dirname(__file__) #<-- absolute dir the script is in
german_path = "Classification Dataset/UCI Statlog(German Credit Data)/german.data-numeric"
test_ratio=0.2
...
def main():
    train_data, train_target,test_data,test_target=load_data(german_path,20)

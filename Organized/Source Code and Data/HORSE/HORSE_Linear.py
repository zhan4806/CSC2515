...
file = open('HORSE_Linear_result.txt','w') 
script_dir = os.path.dirname(__file__) #<-- absolute dir the script is in
horse_path1 = "Classification Dataset/HORSE/horse-colic.txt"
horse_path2 = "Classification Dataset/HORSE/horse-colic.test"
test_ratio=0.2
...
def main():
    train_data, train_target,test_data,test_target=load_data([horse_path1,horse_path2],22)
